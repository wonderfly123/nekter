        ...
        <div className="flex-1 min-w-0 pt-0.5">
          ...
          <div
            className={cn(
              ...
              isBarry
                ? 'text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 rounded-lg rounded-tl-none px-4 py-3 border border-gray-100 dark:border-gray-700'
            ...
            {isBarry ? (
              <ReactMarkdown
                components={{
                  ...
                  blockquote: ({ children }) => (
                    <blockquote className="border-l-4 border-orange-300 pl-3 my-3 italic text-gray-600 dark:text-gray-400">
                      {children}
                    </blockquote>
                  ),
                  code: ({ children }) => (
