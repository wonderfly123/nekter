...
export function BarryPanel() {
  ...
  return (
    <>
      {/* Panel */}
      <div className="fixed right-0 top-0 h-full w-[420px] bg-white dark:bg-gray-800 shadow-2xl z-50 flex flex-col animate-slide-in-right border-l border-gray-200 dark:border-gray-700">
        {/* Header */}
        <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-lg text-gray-900 dark:text-white">Barry</span>
          </div>
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              title="New Chat"
            >
              <PenSquare className="w-5 h-5 text-gray-600 dark:text-gray-400" />
            </button>
              ...
              {showHistoryMenu && (
                <div className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden">
                  <div className="px-3 py-2 border-b border-gray-100 dark:border-gray-700">
                    <span className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Chat History</span>
                  </div>
                  <div className="max-h-80 overflow-y-auto">
                    {sessions?.length === 0 ? (
                      <div className="px-3 py-4 text-sm text-gray-500 dark:text-gray-400 text-center">No conversations yet</div>
                    ) : (
                      sessions?.map((session) => (
                        <div
                          key={session.id}
                          className={cn(
                            'group px-3 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center gap-2 border-b border-gray-50 dark:border-gray-700 last:border-0',
                            session.id === activeSessionId && 'bg-amber-50 dark:bg-amber-900/30',
                ...
                <div className="px-6 py-4">
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0 pt-0.5">
                      ...
                      <div className="text-[15px] leading-relaxed text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 rounded-lg rounded-tl-none px-4 py-3 border border-gray-100 dark:border-gray-700">
