  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative w-9 h-9 flex items-center justify-center bg-gray-50 rounded-lg hover:bg-orange-100 transition-colors group"
      >
        <Bell className="w-4.5 h-4.5 text-gray-600 group-hover:text-orange-600 transition-colors" />
        {unreadCount > 0 && (
