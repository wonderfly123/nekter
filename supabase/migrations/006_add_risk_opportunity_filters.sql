-- =====================================================
-- Update Search Interactions Function with Risk/Opportunity Filters
-- Created: 2026-01-04
-- Purpose: Add filtering by churn_risk and expansion_opportunity flags
-- =====================================================

-- Drop the old function signature first (5 parameters)
DROP FUNCTION IF EXISTS search_interactions(TEXT, TEXT, TEXT, INTEGER, INTEGER);
...
COMMENT ON FUNCTION search_interactions IS 'Unified search across call transcripts, emails, and zendesk tickets with filtering by account, search term, interaction type, date range, churn risk, and expansion opportunity flags';
